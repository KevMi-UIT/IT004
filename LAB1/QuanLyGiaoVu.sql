CREATE DATABASE QuanLyGiaoVuDB;
...
DROP CONSTRAINT PK_KETQUATHI;

-----DROP FOREIGN KEYS------------------
ALTER TABLE HOCVIEN
DROP CONSTRAINT FK_HOCVIEN_LOP;

ALTER TABLE LOP
DROP CONSTRAINT FK_LOP_HOCVIEN;
...
ALTER TABLE DIEUKIEN
DROP CONSTRAINT FK_DIEUKIEN_MONHOC;

ALTER TABLE DIEUKIEN
DROP CONSTRAINT FK_DIEUKIEN_MONHOC_TRUOC;

ALTER TABLE GIAOVIEN
DROP CONSTRAINT FK_GIAOVIEN_KHOA;

ALTER TABLE GIANGDAY
DROP CONSTRAINT FK_GIANGDAY_GIAOVIEN;

ALTER TABLE GIANGDAY
DROP CONSTRAINT FK_GIANGDAY_LOP;

ALTER TABLE GIANGDAY
DROP CONSTRAINT FK_GIANGDAY_MONHOC;

ALTER TABLE KETQUATHI
DROP CONSTRAINT FK_KETQUATHI_HOCVIEN;

ALTER TABLE KETQUATHI
DROP CONSTRAINT FK_KETQUATHI_MONHOC;
