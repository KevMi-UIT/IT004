...
ALTER TABLE DIEUKIEN ADD CONSTRAINT FK_DIEUKIEN_MONHOC_TRUOC FOREIGN KEY (MAMH_TRUOC) REFERENCES MONHOC(MAMH);
...
-------DROP PRIMARY KEYS------------
ALTER TABLE HOCVIEN DROP CONSTRAINT PK_HOCVIEN;
ALTER TABLE LOP DROP CONSTRAINT PK_LOP;
ALTER TABLE KHOA DROP CONSTRAINT PK_KHOA;
ALTER TABLE MONHOC DROP CONSTRAINT PK_MONHOC;
ALTER TABLE DIEUKIEN DROP CONSTRAINT PK_DIEUKIEN;
ALTER TABLE GIAOVIEN DROP CONSTRAINT PK_GIAOVIEN;
ALTER TABLE GIANGDAY DROP CONSTRAINT PK_GIANGDAY;
ALTER TABLE KETQUATHI DROP CONSTRAINT PK_KETQUATHI;

-----DROP FOREIGN KEYS------------------
ALTER TABLE HOCVIEN DROP CONSTRAINT FK_HOCVIEN_LOP;
ALTER TABLE LOP DROP CONSTRAINT FK_LOP_HOCVIEN;
ALTER TABLE LOP DROP CONSTRAINT FK_LOP_GIAOVIEN;
ALTER TABLE KHOA DROP CONSTRAINT FK_KHOA_GIAOVIEN;
ALTER TABLE MONHOC DROP CONSTRAINT FK_MONHOC_KHOA;
ALTER TABLE DIEUKIEN DROP CONSTRAINT FK_DIEUKIEN_MONHOC;
ALTER TABLE DIEUKIEN DROP CONSTRAINT FK_DIEUKIEN_MONHOC_TRUOC;
ALTER TABLE GIAOVIEN DROP CONSTRAINT FK_GIAOVIEN_KHOA;
ALTER TABLE GIANGDAY DROP CONSTRAINT FK_GIANGDAY_GIAOVIEN;
ALTER TABLE GIANGDAY DROP CONSTRAINT FK_GIANGDAY_LOP;
ALTER TABLE GIANGDAY DROP CONSTRAINT FK_GIANGDAY_MONHOC;
ALTER TABLE KETQUATHI DROP CONSTRAINT FK_KETQUATHI_HOCVIEN;
ALTER TABLE KETQUATHI DROP CONSTRAINT FK_KETQUATHI_MONHOC;

----DISABLE ALL TABLE CONSTRAINT BEFORE INSERT----
...
INSERT INTO GIAOVIEN VALUES ('GV02', 'Tran Tam Thanh', 'TS', 'PGS', 'Nam', '17/12/1965', '20/04/2004', 4.50, 2025000, 'HTTT');
INSERT INTO GIAOVIEN VALUES ('GV03', 'Do Nghiem Phung', 'TS', 'GS', 'Nu', '01/08/1950', '23/09/2004', 4.00, 1800000, 'CNPM');
INSERT INTO GIAOVIEN VALUES ('GV04', 'Tran Nam Son', 'TS', 'PGS', 'Nam', '22/02/1961', '12/01/2005', 4.50, 2025000, 'KTMT');
...
------------ ENABLE ALL TABLE CONSTRAINT AFTER INSERT ---------
