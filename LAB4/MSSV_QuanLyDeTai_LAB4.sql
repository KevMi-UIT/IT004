...
SELECT
  K.TENKHOA,
  GV.MAGV AS MAGV_TRGKHOA,
  GV.HOTEN AS HOTEN_TRGKHOA
FROM
  KHOA K,
  GIAOVIEN GV
WHERE
...
FROM
  ...
  BOMON BM
WHERE
  K.TRGKHOA = BM.TRUONGBM
  AND GV.MAGV = K.TRGKHOA;
...
FROM
  ...
  JOIN GIAOVIEN TK ON TK.MAGV = K.TRGKHOA
WHERE
  ...
  AND NOT EXISTS (
    ...
    (
      ...
      FROM
        ...
        JOIN GIAOVIEN TK1 ON TK1.MAGV = K1.TRGKHOA
      WHERE
        g.HOTEN = G1.HOTEN
